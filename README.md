# Sietch Tabr
[![Repository CI/CD](https://github.com/PedroANeves/Sietch-Tabr/actions/workflows/ci.yml/badge.svg)](https://github.com/PedroANeves/Sietch-Tabr/actions/workflows/ci.yml)
[![Wind Traps (Updater)](https://github.com/PedroANeves/Sietch-Tabr/actions/workflows/update.yml/badge.svg)](https://github.com/PedroANeves/Sietch-Tabr/actions/workflows/update.yml)
[![Health Checks](https://github.com/PedroANeves/Sietch-Tabr/actions/workflows/health.yml/badge.svg)](https://github.com/PedroANeves/Sietch-Tabr/actions/workflows/health.yml)
...
- `build`: uses `./build/sources/<package_name>/<package_name>.tar.gz` to
    generate a `./build/debs/<package_name>_<version>_amd64.deb`
